...
interface SetColorProps{
    images:SelectedTypeImg[],
    cartProduct:CartProductType,
    handleColorSelect:(value:SelectedTypeImg)=>void;
}
export const SetColor:React.FC<SetColorProps> = ({images, cartProduct,handleColorSelect}) => {
  return (
    <div>
            ...
            <div className='flex gap-1'>
                ...
                h-7 w-7 rounded-full
                 ...
                 ${cartProduct.selectedImg.color === image.color ? 'border-[1.5px]':'border-none'}`}>
                    <div style={{background:image.colorCode}} className='h-5 w-5 rounded-full border-[1.2px]
